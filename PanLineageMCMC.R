...
mrna_path        = file.path(getwd(),'DepMap_data','CCLE_expression_22Q2.csv.gz')  #| CCLE_expression.csv file (further gzipped) @ https://figshare.com/articles/dataset/DepMap_22Q2_Public/19700056/2?file=34989919
